...
public class CommentingCode {
    public static void main(String[] args) {
        ...
        //However if you put // BEFORE a line of code
        //System.out.println("Then it is considered a comment);
        //System.out.println("and it won't execute!");
        /*
            This is an example of a multi-line comment. which is useful if you
            want to comment out multiple lines of code quickly.
