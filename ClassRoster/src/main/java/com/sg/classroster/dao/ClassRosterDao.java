...
public interface ClassRosterDao {
    ...
    /**
     * Adds the given Student to the roster and associates it with the student
     * id. If there is already a student associated with the student id, it will
    ...
    /**
     * Removes from the roster the student associated with the student id.
