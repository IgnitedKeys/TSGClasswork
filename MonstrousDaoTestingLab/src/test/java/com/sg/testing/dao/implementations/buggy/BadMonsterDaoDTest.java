...
public class BadMonsterDaoDTest {
    ...
    public void testEditMonster() throws Exception {
        ...
        int id3 = 3;
        testDao.updateMonster(id3, monster1);
        assertNotEquals(testDao.getMonster(id3),testDao.getMonster(id1),"Should not be equal");
...
//the updateMonster method only removes a key if it exists-but if you update
//the key, the old monster data still exists. It's putting the data in the 
//Map, rather than replaceing it.
